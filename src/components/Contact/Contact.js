...
const Contact = (props) => {
  ...
  return (
    <div className={styles.root}>
      ...
      <div className={styles.section}>
        <h4>US Phone Support</h4>
        <p>+1 231-634-6486 (231)-NFINIUM</p>
        <p>Monday to Friday - 9am - 5pm PST</p>
      </div>

      <div className={styles.section}>
        <h4>Email</h4>
        <p>
          You can email our Customer Service team at customerservice@infiniumbattery.com
